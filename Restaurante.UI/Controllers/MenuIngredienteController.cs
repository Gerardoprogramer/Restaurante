    ...
    public class MenuIngredienteController : Controller
    {
        ...
        public async Task<IActionResult> IndexDelMenu()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:7295/api/CatalogoDeIngredientesDelMenu/ObTengaElCatalogoDeLosIngredienteDelMenu");
        ...
        public async Task<IActionResult> IndexListaIngredientes(int id, string Nombre)
        {
            ...
            try
            {
                ...
                var uri = QueryHelpers.AddQueryString("https://localhost:7295/api/CatalogoListaDeIngredientes/ObTengaElCatalogoDeLaListaDeIngredientes", query);
        ...
        public async Task<IActionResult> Asociar(int id)
        {
...

            {
                ...
                var response = await httpClient.GetAsync("https://localhost:7295/api/MenuIngrediente/ObtengaElMenu");
                string apiResponse = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Asociar(string idIngrediente, string idMedidas, Model.AsociarAlMenu laAsociacion)
        {
            try
            {
                ...
                await httpClient.PostAsync("https://localhost:7295/api/MenuIngrediente/AgregueAlMenuDeIngredientes", byteContent);
        ...
        public async Task<IActionResult> Desasociar(int Id)
        {
            ...
            try
            {
                ...
                HttpResponseMessage httpResponseMessage = await httpClient.PutAsync("https://localhost:7295/api/MenuIngrediente/Desasociar", byteContent);
