    ...
    public class MesaOrdenController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:7295/api/MesaOrden/ObtengaLaListaDelOrdenDeLasMesas");
        ...
        public async Task<IActionResult> OrdenarMesa(int id)
        {
...

            {
                ...
                var uri = QueryHelpers.AddQueryString("https://localhost:7295/api/MesaOrden/ObtengaElMenuParaOrdenar", query);
        ...
        public async Task<IActionResult> OrdenarMesa(string idMenu, Model.OrdenarMesa ordenarMesa)
        {
            try
            {
                ...
                await httpClient.PostAsync("https://localhost:7295/api/MesaOrden/AgregueLaOrdenALaMesa", byteContent);
        ...
        public async Task<IActionResult> ServirMesa(int id)
        {
...

            {
                ...
                var uri = QueryHelpers.AddQueryString("https://localhost:7295/api/MesaOrden/FiltrarPorNombreLaListaAServir", query);
                var response = await httpClient.GetAsync(uri);
                string apiResponse = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> ServirMesa(string idMenu, Model.OrdenarMesa ordenarMesa)
        {
            try
            {
                ...
                await httpClient.PostAsync("https://localhost:7295/api/MesaOrden/EliminarElPlatilloServido", byteContent);
