    ...
    public class MedidasController : Controller
    {
        ...
        public async Task<IActionResult> Index(string nombre)
        {
            ...
            try
            {
                ...
                if (nombre is null)
                {
                    ...
                    var urlTaza = QueryHelpers.AddQueryString("https://localhost:7295/api/Medidas/ObtengaLaMedidaPorNombre", Taza);
                    ...
                    var urlPizca = QueryHelpers.AddQueryString("https://localhost:7295/api/Medidas/ObtengaLaMedidaPorNombre", Pizca);
                    ...
                    var urlCuchara = QueryHelpers.AddQueryString("https://localhost:7295/api/Medidas/ObtengaLaMedidaPorNombre", Cuchara);
                    ...
                    var urlLitro = QueryHelpers.AddQueryString("https://localhost:7295/api/Medidas/ObtengaLaMedidaPorNombre", Litro);
                    ...
                    var urlMililitros = QueryHelpers.AddQueryString("https://localhost:7295/api/Medidas/ObtengaLaMedidaPorNombre", Mililitros);
                    ...
                    var response = await httpClient.GetAsync("https://localhost:7295/api/Medidas/ObtengaLaListaDeMedidas");
                ...
                else
                {
                    ...
                    var uri = QueryHelpers.AddQueryString("https://localhost:7295/api/Medidas/ObTengaLasMedidasPorNombre", query);
        ...
        public async Task<IActionResult> Details(int id)
        {
...

            {
                ...
                var uri = QueryHelpers.AddQueryString("https://localhost:7295/api/Medidas/ObtenerPorIdLaMedida", query);
                var response = await httpClient.GetAsync(uri);
                string apiResponse = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Create(Model.Medidas medida)
        {
            try
            {
                ...
                await httpClient.PostAsync("https://localhost:7295/api/Medidas", byteContent);
        ...
        public async Task<IActionResult> Edit(Model.Medidas medida)
        {
            try
            {
                ...
                await httpClient.PutAsync("https://localhost:7295/api/Medidas/Editar", byteContent);
