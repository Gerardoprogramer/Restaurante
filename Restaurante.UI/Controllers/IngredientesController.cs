    ...
    public class IngredientesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:7295/api/Ingredientes/ObtengaLaListaDeIngredientes");
        ...
        public async Task<IActionResult> Details(int id)
        {
...

            {
                ...
                var uri = QueryHelpers.AddQueryString("https://localhost:7295/api/Ingredientes/ObtenerPorIdElIngrediente", query);
        ...
        public async Task<IActionResult> Create(Model.Ingredientes ingredientes)
        {
            try
            {
                ...
                await httpClient.PostAsync("https://localhost:7295/api/Ingredientes", byteContent);
        ...
        public async Task<IActionResult> Edit(Model.Ingredientes ingredientes)
        {
            try
            {
                ...
                await httpClient.PutAsync("https://localhost:7295/api/Ingredientes/EditarElIngrediente", byteContent);
